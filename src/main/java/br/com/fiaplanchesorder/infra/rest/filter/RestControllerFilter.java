package br.com.fiaplanchesorder.infra.rest.filter;
...
public class RestControllerFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        loggingHandlerHttpRequest(wrappedRequest, uuid);
    ...
    private void loggingHandlerHttpRequest(CopyableHttpServletRequestWrapper requestWrapper, String uuid) throws IOException {
